                            ...
                            <div class="modal-dialog">
                              ...
                              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post">
                                          <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <input name="kelas" type="text" value="<?=$k['id_mkelas'] ?>" class="form-control">
                                            </div>
                                        ...
                                        <?php 
                                        if (isset($_POST['edit'])) {
                                            $save= mysqli_query($con,"UPDATE tb_mkelas SET id_mkelas='$_POST[kelas]' WHERE id_mkelas='$_POST[id]' ");
                                            if ($save) {
                                                echo "<script>
                                                alert('Data diubah !');
