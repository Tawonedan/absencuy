...
<div class="col-md-12 mt-3">	
				...
				<div class="alert alert-primary alert-dismissible " role="alert" type="button" data-toggle="collapse" data-target="#collapseRekapNovember">
					<strong>REKAP BULAN (November) </strong> 
					<div class="collapse" id="collapseRekapNovember">
							...
							WHERE _logabsensi.tgl_absen BETWEEN '2023-11-01' AND '2023-11-30';
                            "
